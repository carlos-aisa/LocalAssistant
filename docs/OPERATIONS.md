...
de estado configurado debe ser absoluto. El esquema 5 contiene la identidad del
propietario y los scopes concedidos, incluido `conversations.read`, pero no una API key
ni su hash. Al cargar esquemas 1, 2, 3 o 4, la aplicación conserva los datos estables,
añade las capacidades vigentes y elimina el hash legado cuando exista mediante una
reescritura atómica. Aunque el archivo no guarda
